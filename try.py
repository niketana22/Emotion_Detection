...
classifier.load_weights("/Users/niketanabhagat/Desktop/EmotionDetection/emotion_model.h5")

#load face
try:
    face_cascade = cv2.CascadeClassifier('/Users/niketanabhagat/Desktop/EmotionDetection/haarcascade_frontalface_default.xml')
except Exception:
